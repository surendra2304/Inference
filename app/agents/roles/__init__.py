...
FRIDAY_UNIVERSE_PREAMBLE = (
    ...
    "6. FUTURIS (https://futuris-th6f.onrender.com): Calibrated Probabilistic Predictive Forecasting Engine.\n"
    "7. CORTEX (https://cortex-0m7c.onrender.com): Autonomous Web Operations, Browser Automation, and Live Intelligence Scraping.\n"
    "8. FORGE (https://forge-e9kl.onrender.com): Local Software Engineering, Code Synthesis, Refactoring, and AST Analysis Engine.\n"
